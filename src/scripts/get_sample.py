...
if __name__ == "__main__":
    ...
    # print(files)
    assert len(files) > sample_size, \
        f"Not enough files in input folder. Found {len(files)}, need {sample_size}."

    assert os.path.exists(input_meta_file), \
        f"Metadata file '{input_meta_file}' does not exist."
