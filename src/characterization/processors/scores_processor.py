...
class ScoresProcessor(BaseProcessor[BaseScorer]):
    """Processor for computing and saving scores from a dataset using a scoring characterizer."""

    def __init__(self, config: DictConfig, dataset: BaseDataset, characterizer: BaseScorer) -> None:
        ...
        Args:
            ...
            characterizer (BaseScorer): The scorer to apply across the dataset scenarios.
