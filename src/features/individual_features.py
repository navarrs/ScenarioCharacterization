...
class IndividualFeatures(BaseFeature):
    def __init__(self, config: DictConfig) -> None:
        ...
        :param config: Configuration for the feature. Expected to contain key-value pairs 
    ...
    def compute(self, scenario: Dict) -> Dict:
        ...
        for n in range(N):
            ...
            agent_types = scenario['agent_types'][n]
            ...
            waiting_period, waiting_intervals, waiting_distances = individual.compute_waiting_period(
                agent_positions, speed, timestamps, conflict_points, stationary_speed 
            )
            ...
            if self.return_criteria == 'critical':
                ...
                waiting_period, waiting_intervals = waiting_period.max(), waiting_intervals.max()
                ...
                waiting_period, waiting_intervals = waiting_period.mean(), waiting_intervals.mean()
